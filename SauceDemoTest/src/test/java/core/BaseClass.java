...
public class BaseClass {
    ...
    public void resetApp() {
        WebElement burgerButton = driver.findElement(By.xpath
                ("//button[@id='react-burger-menu-btn']"));
        burgerButton.click();

        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='reset_sidebar_link']")));
        WebElement resetButton = driver.findElement(By.xpath("//a[@id='reset_sidebar_link']"));
        resetButton.click();
        driver.get(SAUCE_DEMO_RESET);
    }
