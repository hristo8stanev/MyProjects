...
public class UserActions {
    ...
    public void clickAndDragElement(String cardKey, String listKey, Object... arguments) {
        LOGGER.info("Clicking on element " + cardKey);
        WebElement element = driver.findElement(By.xpath(cardKey));
        WebElement location = driver.findElement(By.xpath(listKey));


        Actions act = new Actions(driver);
        act.dragAndDrop(element, location).build().perform();
    }
}
